...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('forms_field', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=200))
    def backwards(self, orm):
        ...
        # Changing field 'Field.slug'
        db.alter_column('forms_field', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=100))
    models = {
        'forms.field': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'default': "''", 'max_length': '200', 'blank': 'True'}),
